    ...
    fun print (outstream, e0) =
        ...
        and   exp(A.Lvalue v, d) = (space d; sayln "Lvalue("; var(v,d+1); say ")")
            ...
            and dec(A.FuncDec l, d) =  
                let fun field((i,ti):A.tyfield,d) = (space d; say "("; say(i); say ","; say(ti); say ")") 
              ...
              | dec(A.TypeDec l, d) = 
                let fun tdec((i:Ast.type_id,t),d) = (space d; say"("; say(i); sayln ","; ty(t,d+1); say ")")
            ...
            and   ty(A.alias(s), d) = (space d; say "alias("; say(s);say ")")
                ...
                | ty(A.record l, d) =  
                    let fun f((i,t),d) = (space d; say "("; say (i); say ",";  say ","; say (t); say ")")
